import logo from "../assets/MSPIC.png";
...
const Navbar = () => {
  ...
  const handleLinkedInClick = () => {
    window.open('https://www.linkedin.com/in/muskaan-sharma-b73b26242/', '_blank');
  };

  const handleGithubClick = () => {
    window.open('https://github.com/muskaan-1801', '_blank');
  };

  const handleLeetcodeClick = () => {
    window.open('https://leetcode.com/u/muskaan_1801/', '_blank');
  };
